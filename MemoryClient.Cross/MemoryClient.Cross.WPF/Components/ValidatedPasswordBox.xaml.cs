...
namespace MemoryClient.Cross.WPF.Components
{
    /// <inheritdoc />
    /// <summary>
    /// Interaction logic for ValidatedPasswordBox.xaml
    /// </summary>
    public partial class ValidatedPasswordBox
    {
        public string Text
        {
        ...
        public static readonly DependencyProperty TextProperty =
            DependencyProperty.Register("Text", typeof(string), typeof(ValidatedPasswordBox), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty OverrideErrorProperty =
            DependencyProperty.Register("OverrideError", typeof(string), typeof(ValidatedPasswordBox), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty OverrideWarningProperty =
            DependencyProperty.Register("OverrideWarning", typeof(string), typeof(ValidatedPasswordBox), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty ErrorValidatorProperty =
            DependencyProperty.Register("ErrorValidator", typeof(Func<string, string>), typeof(ValidatedPasswordBox), new PropertyMetadata(default(Func<string, string>)));
        ...
        public static readonly DependencyProperty WarningValidatorProperty =
            DependencyProperty.Register("WarningValidator", typeof(Func<string, string>), typeof(ValidatedPasswordBox), new PropertyMetadata(default(Func<string, string>)));
        ...
        public static readonly DependencyProperty IsValidProperty =
            DependencyProperty.RegisterReadOnly("IsValid", typeof(bool), typeof(ValidatedPasswordBox), new PropertyMetadata(true)).DependencyProperty;
