...
namespace MemoryClient.Xamarin.Infrastructure {

    public abstract class AppMapViewModelBase : BindableBase, INavigationAware, IConfirmNavigation, IDestructible
    {
        private const string RootUriPrependText = "/";
        private DelegateCommand<string> _navigateAbsoluteCommand;
        private DelegateCommand<string> _navigateCommand;
        private DelegateCommand<string> _navigateModalCommand;
        private DelegateCommand<string> _navigateNonModalCommand;
